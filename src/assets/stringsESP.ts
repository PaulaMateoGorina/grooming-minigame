export const GENERAL_STRINGS = {
    ...
    PROMPT_QUESTIONNAIRE_START: "Por favor, rellena el siguiente cuestionario antes de empezar a jugar: ",
    PROMPT_QUESTIONNAIRE_RESET: "Antes de volver a jugar, recuerda completar el cuestionario que comenzaste al inicio de la sesión.",
