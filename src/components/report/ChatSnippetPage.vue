<template>
  <div v-for="snippetIdxPair in snippetIdxPairs" :key="snippetIdxPair[0].id">
    <ChatSnippetComponent :chatSnippet="snippetIdxPair[0]" :arrayIdx="snippetIdxPair[1]" :isGrooming="isGrooming" :correctness="correctness"/>
  </div>
</template>
